...
try :
    from .bbox import bbox_clip_xyxy, bbox_xywh_to_xyxy
except :
    from bbox import bbox_clip_xyxy, bbox_xywh_to_xyxy
...
class CocoDetection(VisionDataset):
    ...
    def __init__(self, root, splits, transform=None, transforms=None, min_object_area=0,
...
if __name__ == "__main__":
    data  = CocoDetection(root='/home/datadisk2/dataset/COCO/',
         splits='instances_train2014', use_crowd=False)
